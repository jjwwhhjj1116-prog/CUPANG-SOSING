...
export default async function Home() {
  ...
  if(process.env.NODE_ENV==='production'&&!user?.verifiedAccess)return <main style={{maxWidth:680,margin:'12vh auto',padding:32,fontFamily:'sans-serif'}}><h1>SourceFlow 로그인 확인</h1><p>이 작업 공간은 Cloudflare Access로 보호됩니다.</p><p>{accessMessage}</p><form action="/" method="get"><button type="submit">다시 확인</button></form></main>;
