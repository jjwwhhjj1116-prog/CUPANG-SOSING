...
type Props={jobId:string;productId?:string|null;onSaved:()=>void;onOpenProduct?:(productId:string,tab:'대표 이미지'|'옵션',signal:AbortSignal)=>Promise<void>};
...
function CollectionResultContent({jobId,productId,onSaved,onOpenProduct}:Props){
 ...
 async function openEditor(tab:'대표 이미지'|'옵션'){
