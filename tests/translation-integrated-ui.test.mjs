...
function harness(handler) {
 const slots=[],cleanups=[],calls=[]; let index=0,first=true,saved=0,closed=false,late=0;
 ...
 const render=()=>{index=0;const tree=exports.TranslationIntegratedPreview({productId:'p',version,jobId:'j',disabled:false,onSaved:()=>saved++});first=false;return tree;};
