...
function harness(handler,status='completed'){
 ...
 let initial=0;
 const fetcher=async(url,init)=>{if(initial<2){initial++;return Response.json(url.endsWith('/translation')?view:{content});}calls.push({url,init});return handler(url,init,{content,job});};
